...
const Contact: React.FC = () => {
    return (
      <section id="contact" className="w-full mb-10 flex flex-col items-center">
        <div className="flex flex-col items-center mb-5 w-fit">
          <h1 className="text-3xl font-bold text-center text-skin-title">Contact Me!</h1>
        ...
        <div className="p-6 flex flex-col sm:flex-row bg-skin-fillDark border-4 border-skin-accent rounded-2xl shadow-md">
          ...
          <div id="iconList" className="sm:p-5 flex flex-col grow">
            <Link href="https://github.com/ray-jpl">
              <a className="group flex items-center p-1 rounded-lg hover:text-skin-accent">
            ...
            <div className="group flex items-center p-1 rounded-lg hover:text-skin-accent">
