  ...
  return (
    <div className='smooth-scroll'>
      <div className="flex flex-col items-center bg-skin-fill text-skin-primary min-h-screen w-full">
        <Head>
          <link rel="icon" href="/ray_circle.png" />
          <meta
            name="description"
        ...
        <div className="p-6 w-full sm:w-4/5 md:w-1/2 2xl:max-w-7xl flex-1">
          <main>{children}</main>
          {!home && (
        ...
        <footer className="min-w-full border-t-2">
          <div className="my-10 flex justify-center items-center gap-x-6 ">
            <Link
